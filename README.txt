...
To run this API, it can be run with:  uvicorn main:app --reload
...
The API can be called via an API, Attached is the postman collection to test the API directly.

Basically the API could be deployed locally and it should be accessible at : http://127.0.0.1:8000/
